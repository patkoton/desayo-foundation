...
const Hero = () => {
  return (
    <div className='font-poppins'>
        <div className='w-full flex justify-center mt-5 md:mt-20'>
                <div className='w-full md:w-9/12 text-black text-center'>
                    ...
                    <div className='w-full flex justify-center'>
                        <div className='flex gap-4 md:gap-10'>
                            <Button children='Learn More' className='text-purple font-medium px-2 md:px-6' />
                            <Button children='Volunteer' className='bg-purple text-white font-normal px-2 md:px-6' />
                        </div>
                    </div>
                </div>
        </div>
