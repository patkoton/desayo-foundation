    ...
    <div className='md:px-14 font-poppins mb-16 md:my-20 text-black'>
        <div className='flex flex-col md:flex-row md:justify-between md:items-center'>
            ...
            <div className='md:flex items-center md:gap-6 mt-2.5 md:mt-0'>
                <Button children='Get Involved' className='text-purple font-medium px-2 md:px-6 mr-2' />
                <Button children='Donate' className='bg-purple text-white font-normal px-2 md:px-6' />
            </div>
        </div>
    </div>
  )
